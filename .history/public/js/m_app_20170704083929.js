...
var coding_input_message = "no"; //코딩 셋팅 여부 판별 yes || no  = > 파일받기 관여
...
$(document).ready(function () {
	...
	$(".downBtn").on('click', function () {
		if (coding_input_message == "yes") {
			download('mobile_swipe.html' , str)
		}else{
			alert("먼저 입력해주세요!")
		}
	});
