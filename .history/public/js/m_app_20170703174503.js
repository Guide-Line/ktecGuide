				...
				<head>
					...
					<style type="text/css">
						*{margin:0;padding:0}
						...
						#p_wrapper_slide .slider_wrap{position:relative;overflow:hidden;background:#fff;padding-bottom:10%}
						...
						#p_wrapper_slide .swiper-pagination{width:100%;text-align:center;position:absolute;left:0;bottom:10%; }
						...
						#p_wrapper_slide .swiper-button-prev{opacity:0.3;width:40px;height:40px;z-index:10;top:44%;background-color:#fff;background-size:30px 20px;margin-top:-20px;left:0}
						#p_wrapper_slide .swiper-button-next{opacity:0.3;width:40px;height:40px;z-index:10;top:44%;background-color:#fff;background-size:30px 20px;margin-top:-20px;right:0}	
