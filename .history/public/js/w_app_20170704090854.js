...
var coding_souce_message_empty="yes"; //셋팅된 소스 유무
...
$(document).ready(function(){
	...
	$(".downBtn").on('click', function () {
		if(coding_souce_message_empty == "no"){
			if (coding_souce_message == "yes") {
				download('desktop_swipe.html' , str)
			}else{
				alert("소스보기 버튼을 클릭하여 코드를 갱신 해주세요!")
			}
		}else{
			alert("소스보기 버튼을 클릭하여 코드를 갱신 해주세요!")
		};
