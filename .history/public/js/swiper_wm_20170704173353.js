...
var coding_souce_message = "no"; //ï¿½ëƒ¼ï¿½ë’ªè¹‚ë‹¿ë¦? ï¿½ê²¢?”±ï¿? ï¿½ì???‡¾ï¿?
...
function ui_update() {
	...
	//ï¿½ë¸¯ï¿½ë–’ ï¿½ë¸˜ï¿½ì” ?‚„ï¿? x è¸°ê¾ª?“‰ ï¿½ì £ï¿½ë¼±
	var $this;
...
/*ï¿½ê¸½ï¿½ê¹­ ï¿½ê½•ï¿½ì ™åª›ï¿½ ï§â‘¤ëª? ?¥?‡ë¦°ï¿½?†•*/
function allClear() {
	total = -1;
	isView = -1;
	pop_img; // ï¿½ë™˜ï¿½ë¾½ï¿½ë¿‰ ï¿½ëª´ï¿½ë–†ï¿½ë¦ºï¿½ë’— ï¿½ì” èª˜ëª„ï¿½ï¿½ ï¿½ï¿½ï¿½ï¿½?˜£
	pop_link; // ï¿½ë™˜ï¿½ë¾½ï¿½ë¿‰ ï¿½ëª´ï¿½ë–†ï¿½ë¦ºï¿½ë’— ï¿½ì” èª˜ëª„ï¿½ï¿½ ï§ê³¹ê²? ï¿½ï¿½ï¿½ï¿½?˜£
	isBtnNum = 0;
	input_state = false;
	ptemp = -1;
	...
	$('#sortable').empty();
	$("#p_wrapper_slide").empty();
	$('#resultArea textarea').val(""); //ï¿½ëƒ¼ï¿½ë’ªè¹‚ë‹¿ë¦°ï§¡ï¿? ?¥?‡ë¦°ï¿½?†•
	popup_clear();
	coding_souce_message = "no";
}
