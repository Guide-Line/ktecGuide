...
function ui_update(){
	...
	$("#p_wrapper_slide").append(`<div class="slider_wrap">
		...
		<script>
			var swiper01 = new Swiper('#p_wrapper_slide  .swiper-container', {				
				autoplay : 4500,
				...
				<head>
					...
					<style type="text/css">
						*{margin:0;padding:0}
						...
						#p_wrapper_slide .swiper-pagination{width:100%;text-align:center;position:absolute;left:0;bottom:5%}
